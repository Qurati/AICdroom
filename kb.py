...
save_btn1 = InlineKeyboardButton('Сохранить', callback_data='save_1')
load_btn1 = InlineKeyboardButton('Загрузить', callback_data='load_1')
delete_btn1 = InlineKeyboardButton('Удалить', callback_data='delete_1')
...
save_btn2 = InlineKeyboardButton('Сохранить', callback_data='save_2')
load_btn2 = InlineKeyboardButton('Загрузить', callback_data='load_2')
delete_btn2 = InlineKeyboardButton('Удалить', callback_data='delete_2')
...
save_btn3 = InlineKeyboardButton('Сохранить', callback_data='save_3')
load_btn3 = InlineKeyboardButton('Загрузить', callback_data='load_3')
delete_btn3 = InlineKeyboardButton('Удалить', callback_data='delete_3')
